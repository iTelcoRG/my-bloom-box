...
The brand palette uses Soft Blush (#FFF9FB) and white backgrounds, Bloom Pink (#FFB4E2) accents, charcoal (#332D32) primary text and muted charcoal (#6F666D) supporting text. Primary buttons hover to #F7A4D5; borders use #F1E5EC. Pale pink (#FFF0F8) is reserved for feature surfaces, with sparing gold (#B89A62) decorative details. SVG placeholders use the same palette pending approved photography. Georgia/Arial fonts and existing layouts are preserved. Pink buttons/announcement use dark text for legibility. No eyebrow headings, remote fonts, remote image services, analytics or ecommerce dependencies are included.
