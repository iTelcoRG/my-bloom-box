...
The brand palette uses Soft Blush (#FFF9FB) and white (#FFFFFF) backgrounds, primary accent pink (#F24B93) for small brand details, focus indicators and CTA borders, and softer Bloom Pink (#FFB4E2) for button fills and decorative product elements. Text uses charcoal (#332D32) and supporting copy uses #6F666D; borders use #F1E5EC, with sparing gold (#B89A62) decorative details. Tinted surfaces, hover fills and translucent shadows derive from these tokens with CSS colour mixing. Buttons retain charcoal text on soft pink for readable contrast. SVG placeholders use the brand palette plus natural foliage greens pending approved photography. Layout, typography, spacing, content, navigation and functionality are unchanged. No remote fonts, remote image services, analytics or ecommerce dependencies are included.
